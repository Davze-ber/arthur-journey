from items_inventory.items import Item, Potion, Weapon, Material, Junk, Shield
...
item_lst = {
    ...
    "Rejuvenation Potion" : lambda: Potion("Rejuvenation Potion", "Potion", "rejuvenation", value=10, healing_amount=5,restore_mana=5)
   }

weapon_dict = {
    "Wood Stick" : lambda: Weapon("Wooden Stick", "weapon", "main_hand", 0, weapon_damage=1),
    "Axe" : lambda: Weapon("Axe", "weapon", "main_hand", 10, weapon_damage=2, health=2, strength=2),
...
shield_dict = {
    "Small Shield" : lambda: Shield(name="Small Shield", category="shield", tag="off_hand", defense=2, value=0, block_chance=5),
}
