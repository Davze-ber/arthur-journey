...
enemies_dict = {
       "slime": lambda: Enemy("Slime", resource_type="rage", health=3, strength=1, agility=1, intelligence=1, defense=1, speed=1,level=1, experience=5, gold=1, loot=[junk_lst["Slime Gel"]()]),
